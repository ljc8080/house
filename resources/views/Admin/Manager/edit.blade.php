@extends('admin.public.layout')
      ...
      <div class="layui-fluid">
          @include('admin.public.msg')
            <div class="layui-row">
            <form class="layui-form" method="POST" action="{{route('manager.dealedit',['id'=>$data->id])}}">
                {{ csrf_field() }}
                @method('PUT')
                  ...
                  <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            ...
                            autocomplete="off" class="layui-input" value="{{$data->truename}}">
                        </div>
                        <div class="layui-form-mid layui-word-aux">
                            {{-- <span class="x-red">*</span>将会成为您唯一的登入名 --}}
                        </div>
                  ...
                  <div class="layui-form-item">
                      ...
                      <div class="layui-input-block">
                        @foreach ($roles as $key => $item)
                          <input type="radio" name="role_id" value="{{$key}}" title="{{$item}}" required='' @if ($data->role_id==$key)
                              checked='checked'
                          @endif>
                          @endforeach
                      </div>
                  ...
                  <div class="layui-form-item">
                        ...
                        <div class="layui-input-block">
                          ...
                          @endif
                         >
                          <input type="radio" name="sex" value="女士" title="女士" @if ($data->sex=="女士")
                          checked="checked"
                          @endif>
                        </div>
                      </div>
                      ...
                      <div class="layui-collapse" lay-filter="test">
                            ...
                            <div class="layui-colla-item">
                              <h2 class="layui-colla-title">修改用户密码</h2>
     ...
     layui.use(['form', 'layer'],
            function() {
                ...
                function(data) {
                    console.log(data);
                    http.send({{route('manageradd')}},data)
                    //发异步，把数据提交给php
                    layer.alert("增加成功", {
                        icon: 6
                    },
