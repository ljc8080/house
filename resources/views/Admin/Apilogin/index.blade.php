                ...
                <div class="layui-col-md12">
                    <div class="layui-card">
                      <div class="layui-card-header">
                        ...
                        <button class="layui-btn" onclick="xadmin.open('添加属性','{{route('apilogin.create')}}',600,600)"><i class="layui-icon"></i>添加</button>
                              ...
                              <tbody class="x-cate">
                                ...
                                <tr >
                                  ...
                                  <td class="td-manage">
                                    ...
                                    {{-- {!!$item->edit('apilogin.edit')!!}
                                    
                                    {!!$item->del('apilogin.destroy')!!} --}}
                                  </td>
                                </tr>
                                @endforeach
                              </tbody>
